        ...
        <div class="table-responsive">
            <table class="table visit-table">
                ...
                <tr v-for="(encounter, key) in encounters" v-bind:key="key">
                    ...
                    <td style="width:60px">
                        <input v-model="observations['concept33Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    ...
                    <td style="width:60px">
                        <input v-model="observations['concept37Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');" value="">
                    </td>
                    <td style="width:60px">
                        <input v-model="observations['concept38Encounter'+encounter.encounterID].value" class="form-control" min="0" step="1" oninput="validity.valid||(value='');" value="">
                    </td>
                    <td>
                    ...
                    <td style="width:60px">
                        <input v-model="observations['concept40Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');" value="">
                    </td>
                    <td style="width:30px">
                    ...
                    <td style="width:60px">
                        <input v-model="observations['concept43Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td style="width:60px">
                        <input v-model="observations['concept44Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td>
                    ...
                    <td>
                        <input v-model="observations['concept46Encounter'+encounter.encounterID].value" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td style="width:60px">
                        <input v-model="concepts.concept40" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td style="width:30px">
                    ...
                    <td>
                        <input v-model="concepts.concept43" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td>
                        <input v-model="concepts.concept44" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td>
                    ...
                    <td>
                        <input v-model="concepts.concept46" class="form-control"  type="number" min="0" step="1" oninput="validity.valid||(value='');">
                    </td>
                    <td>
...
import { networkInterfaces } from 'os';
    ...
    export default {
        ...
        watch : {
            ...
            'concepts.concept40': function(){
                if (this.concepts.concept32 !== '' && this.concepts.concept32 !== undefined){
                    this.concepts.concept47 = this.assignNextAppointment(this.concepts.concept32, this.concepts.concept40)
                }
            }
        }
    }
