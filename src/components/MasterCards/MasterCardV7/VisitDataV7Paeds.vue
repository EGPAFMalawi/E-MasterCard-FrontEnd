        ...
        <div class="table-responsive">
            <table class="table visit-table">
                ...
                <tr v-for="(encounter, key) in encounters" v-bind:key="key">
                    ...
                    <td style="width:60px">
                        <input v-model="observations['concept37Encounter'+encounter.encounterID].value" class="form-control tb-form"  type="number" value=""  min="0" max="180" :disabled="observations['concept32Encounter'+encounter.encounterID].isOutcome">
                    </td>
                    <td style="width:60px">
                ...
                <tr v-if="!this.patient.person.dead">
                    ...
                    <td style="width:60px">
                        <input :disabled="!isVisit && isOutcome" v-model="concepts.concept37" class="form-control tb-form"  type="number" min="0" max="180" step="1" onblur="validity.valid||(value='');">
                    </td>
                    <td style="width:60px">
                    ...
                    <td style="width:60px">
                        ...
                        type="number" min="15" max="600" onblur="validity.valid||(value='');">
                    </td>
                    <td style="width:30px">
                    ...
                    <td>
                        <input :disabled="!isIPT" v-model="concepts.concept43" class="form-control tb-form" type="number" min="15" max="360" step="1" onblur="validity.valid||(value='');">
                    </td>
                    <td>
